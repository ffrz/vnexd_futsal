...
class Cart extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['diskon'] = $this->db->select('harga')->where('id', '1')->get('diskon')->row_array();
    ...
    public function buy($id)
    {
        ...
        if ($row) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-block alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><i class="ace-icon fa fa-bullhorn green"></i> Data tidak ditemukan</div>');
            redirect(base_url());
        }
    }
    ...
    public function checkout()
    {
        ...
        if ($this->session->userdata('usertype') == "3") {
            $diskon = $this->db->select('harga')->where('id', '1')->get('diskon')->row()->harga;
        } else {
            $diskon = '0';
        }
