<aside class="main-sidebar">
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php if ($this->uri->segment(2) == "prices") {
            echo "class='active'";
          } ?>>
        <a href='<?= base_url('admin/prices') ?>'><i class='fa fa-list'></i><span> Tarif Sewa</a>
      </li>
      <li <?php if ($this->uri->segment(2) == "lapangan") {
        ...
        <ul class='treeview-menu'>
          <li <?php if ($this->uri->segment(2) == "lapangan" && $this->uri->segment(3) == "create") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/lapangan/create') ?>'><i class='fa fa-circle-o'></i> Tambah Lapangan </a></li>
          <li <?php if ($this->uri->segment(2) == "lapangan" && $this->uri->segment(3) == "") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/lapangan') ?>'><i class='fa fa-circle-o'></i> Data Lapangan </a></li>
        </ul>
      </li>
      <li <?php if ($this->uri->segment(2) == "album") {
        ...
        <ul class='treeview-menu'>
          <li <?php if ($this->uri->segment(2) == "album" && $this->uri->segment(3) == "create") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/album/create') ?>'><i class='fa fa-circle-o'></i> Tambah Album </a></li>
          <li <?php if ($this->uri->segment(2) == "album" && $this->uri->segment(3) == "") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/album') ?>'><i class='fa fa-circle-o'></i> Data Album </a></li>
        </ul>
      </li>
      <li <?php if ($this->uri->segment(2) == "foto") {
        ...
        <ul class='treeview-menu'>
          <li <?php if ($this->uri->segment(2) == "foto" && $this->uri->segment(3) == "create") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/foto/create') ?>'><i class='fa fa-circle-o'></i> Tambah Foto </a></li>
          <li <?php if ($this->uri->segment(2) == "foto" && $this->uri->segment(3) == "") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/foto') ?>'><i class='fa fa-circle-o'></i> Data Foto </a></li>
        </ul>
      </li>
      <li <?php if ($this->uri->segment(2) == "event") {
        ...
        <ul class='treeview-menu'>
          <li <?php if ($this->uri->segment(2) == "event" && $this->uri->segment(3) == "create") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/event/create') ?>'><i class='fa fa-circle-o'></i> Tambah Event </a></li>
          <li <?php if ($this->uri->segment(2) == "event" && $this->uri->segment(3) == "") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/event') ?>'><i class='fa fa-circle-o'></i> Data Event </a></li>
        </ul>
      </li>
      <li <?php if ($this->uri->segment(2) == "kategori") {
        ...
        <ul class='treeview-menu'>
          <li <?php if ($this->uri->segment(2) == "kategori" && $this->uri->segment(3) == "create") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/kategori/create') ?>'><i class='fa fa-circle-o'></i> Tambah Kategori </a></li>
          <li <?php if ($this->uri->segment(2) == "kategori" && $this->uri->segment(3) == "") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/kategori') ?>'><i class='fa fa-circle-o'></i> Data Kategori </a></li>
        </ul>
      </li>
      <li <?php if ($this->uri->segment(2) == "slider") {
        ...
        <ul class='treeview-menu'>
          <li <?php if ($this->uri->segment(2) == "slider" && $this->uri->segment(3) == "create") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/slider/create') ?>'><i class='fa fa-circle-o'></i> Tambah Slider </a></li>
          <li <?php if ($this->uri->segment(2) == "slider" && $this->uri->segment(3) == "") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/slider') ?>'><i class='fa fa-circle-o'></i> Data Slider </a></li>
        </ul>
      </li>
      <li <?php if ($this->uri->segment(2) == "kontak") {
        ...
        <ul class='treeview-menu'>
          <li <?php if ($this->uri->segment(2) == "kontak" && $this->uri->segment(3) == "create") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/kontak/create') ?>'><i class='fa fa-circle-o'></i> Tambah Kontak </a></li>
          <li <?php if ($this->uri->segment(2) == "kontak" && $this->uri->segment(3) == "") {
                echo "class='active'";
              } ?>><a href='<?php echo base_url('admin/kontak') ?>'><i class='fa fa-circle-o'></i> Data Kontak </a></li>
        </ul>
      </li>
      <li class="header">
      ...
      <li <?php if ($this->uri->segment(3) == "update_diskon") {
            echo "class='active'";
          } ?>><a href='<?php echo base_url() ?>admin/transaksi/update_diskon/1'> <i class="fa fa-scissors"></i> <span>Diskon Member</span> </a> </li>
      <li <?php if ($this->uri->segment(2) == "company") {
            echo "class='active'";
          } ?>><a href='<?php echo base_url() ?>admin/company/update/1'> <i class="fa fa-building"></i> <span>Profil</span> </a> </li>
        ...
        <li <?php if ($this->uri->segment(2) == "auth" && $this->uri->segment(3) == "") {
          ...
          <ul class='treeview-menu'>
            <li <?php if ($this->uri->segment(2) == "auth" && $this->uri->segment(3) == "create_user") {
                  echo "class='active'";
                } ?>><a href='<?php echo base_url() ?>admin/auth/create_user'><i class='fa fa-circle-o'></i> Tambah User</a></li>
            <li <?php if ($this->uri->segment(2) == "auth" && $this->uri->segment(3) == "") {
                  echo "class='active'";
                } ?>><a href='<?php echo base_url() ?>admin/auth/'><i class='fa fa-circle-o'></i> Data User</a></li>
          </ul>
        </li>
      <?php endif ?>
